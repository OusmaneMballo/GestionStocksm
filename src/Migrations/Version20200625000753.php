 ...
 */
final class Version20200625000753 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE entree ADD user_id INT DEFAULT NULL, CHANGE produit_id produit_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE produit ADD user_id INT DEFAULT NULL, CHANGE qtstocke qtstocke INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27A76ED395 ON produit (user_id)');
        $this->addSql('ALTER TABLE sortie ADD user_id INT DEFAULT NULL, CHANGE produit_id produit_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE entree DROP user_id, CHANGE produit_id produit_id INT DEFAULT NULL');
        $this->addSql('DROP INDEX IDX_29A5EC27A76ED395 ON produit');
        $this->addSql('ALTER TABLE produit DROP user_id, CHANGE qtstocke qtstocke INT DEFAULT NULL');
        $this->addSql('DROP INDEX IDX_3C3FD3F2A76ED395 ON sortie');
        $this->addSql('ALTER TABLE sortie DROP user_id, CHANGE produit_id produit_id INT DEFAULT NULL');
    }
}
